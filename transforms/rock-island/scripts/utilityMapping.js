/**
 * Rock Island County — utility mapping.
 *
 ...
 * "Required script not found"). The county GIS parcel layer carries no per-utility detail —
 * it publishes one row per parcel, not per building, room or service connection.
 *
 * This module therefore writes nothing and exits 0. Inventing a utility record to fill the
